...
(`trace.jsonl`)](../reference/observability-schemas.md#session-trace-tracejsonl) and [Structured evaluation
(`eval.jsonl`)](../reference/observability-schemas.md#structured-evaluation-evaljsonl) for the full schemas, and
