...
- [`E-CAP-006` and `W-SEC-012` in context](diagnostics.md#e-cap-006) — what
  each check does, and what it deliberately does not do.
- [`W-SEC-012`](diagnostics.md#w-sec-012) — the warning's full write-up, including why it is
