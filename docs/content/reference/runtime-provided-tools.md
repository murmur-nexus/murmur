...
| `delegate-task` | [`capabilities.spawn.allow`](manifest.md#field-capabilities) | Hands one task to one sub-capsule and waits for its answer — see [The delegation tool](roost-api.md#the-delegation-tool) |
