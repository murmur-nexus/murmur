...
//! overrides by `shell::build_shell_env` before it is spawned. What that costs, and why it is
//! accepted, is recorded in `docs/content/reference/child-dumpable-tradeoff.md`.
